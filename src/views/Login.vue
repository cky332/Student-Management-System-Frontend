  ...
  <div class="login-container">
    <el-form class="login-form" autocomplete="on" label-position="left">
      ...
      <el-form-item>
        ...
        <el-input ref="username" v-model="username" placeholder="Username" name="username" type="text" tabindex="1"
          autocomplete="on" />
      </el-form-item>
      ...
      <el-tooltip>
        <el-form-item>
          ...
          <el-input v-model="password" type="password" placeholder="Password" name="password" />
          <span class="show-pwd">
            <svg-icon icon-class="password" />
          </span>
        </el-form-item>
      </el-tooltip>
      <el-button type="succeed" style="width: 60%; margin-bottom: 30px" @click="handleSubmit">登录</el-button>
    </el-form>
...
.login-container {
  ...
  width: 100%;
  background-color: $bg;
  background-color: rgb(182, 186, 123);
  overflow: hidden;
